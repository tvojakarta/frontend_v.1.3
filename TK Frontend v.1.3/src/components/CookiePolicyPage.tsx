        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 space-y-1">
              <p><strong>Email:</strong> podrska@tvojakarta.com</p>
              <p><strong>{language === 'sr' ? 'Telefon:' : 'Phone:'}</strong> +387 66 373 666</p>
              <p><strong>{language === 'sr' ? 'Adresa:' : 'Address:'}</strong> Prvog krajiškog korpusa 58, 78000 Banja Luka</p>
            </div>
          </CardContent>
        </Card>
      </div>
