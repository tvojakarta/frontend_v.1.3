...
export function Footer({ onNavigate, onCategoryFilter }: FooterProps) {
  ...
  const navigationLinks = [
    ...
    { label: t('nav.events'), action: () => onCategoryFilter('') },
    ...
    { label: t('footer.newsletter'), action: () => onNavigate('newsletter') }
  ];
  ...
  const socialLinks = [
    { 
      icon: Facebook, 
      label: 'Facebook', 
      href: 'https://www.facebook.com/sedmica7' 
    },
    { 
      icon: Instagram, 
      label: 'Instagram', 
      href: 'https://www.instagram.com/sedmica_org/' 
    },
    { 
      icon: TikTokIcon, 
      label: 'TikTok', 
      href: 'https://www.tiktok.com/@sedmica_org' 
    }
  ];
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.instagram.com/sedmica_org/" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  sedmica_org
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://www.facebook.com/sedmica7" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  sedmica7
                </a>
              </div>
              ...
              <div className="flex items-center gap-3">
                <TikTokIcon />
                <a href="https://www.tiktok.com/@sedmica_org" target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  @sedmica_org
                </a>
              </div>
            </div>
